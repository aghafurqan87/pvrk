    ...
    Plugin.prototype = {
        ...
        createKeyboard: function (layout) {
            ...
            var keyboard_container = $('<ul/>').addClass('jkeyboard'),
                keyboard_container_1 = $('<ul/>').addClass('jkeyboard'),
                me = this;
            ...
            layouts['numbers_only'].forEach(function (line, index) {
                var line_container = $('<li/>').addClass('jline');
                line_container.append(me.createLine(line));
                keyboard_container_1.append(line_container);
            });


            

            $(this.element).html('').append(keyboard_container).append(keyboard_container_1);
        },
        ...
        events: function () {
            ...
            return_key.on('click', function () {
                me.type("\n");
                $('input.is-focused').parents('form').submit();
            });
